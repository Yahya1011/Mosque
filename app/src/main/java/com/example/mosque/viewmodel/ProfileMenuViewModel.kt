...
class ProfileMenuViewModel  : ViewModel(){
    ...
    private fun fetchNavigation(context: Context) {
        ...
        disposable.add(loadDataNavigation(context)
            ...
            .subscribe({navMenuRespons ->
                println("NAVI RESP Profile ${navMenuRespons.size}")
    ...
    private fun createMenuItem(context: Context): MutableList<MainNav> {
        ...
        val onMenuText = context.resources.getStringArray(R.array.profileMenu)
        val onMenuIcon = context.resources.obtainTypedArray(R.array.profileIcon)
