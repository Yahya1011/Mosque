...
class ProfileMainAdapter(val navData : MutableList<MainNav>) : RecyclerView.Adapter<ProfileMainAdapter.NavMainHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NavMainHolder {
        ...
        val layoutInflater = LayoutInflater.from(mContext).inflate(R.layout.item_main_profile, parent, false)
